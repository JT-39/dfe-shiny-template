...
test_that("App loads and title of app appears as expected", {
  expect_equal(
    app$get_text("title")[1],
    # This is the title of the app on load, you should change to match
    # your app's title
    # The app title is usually set early on in the ui.R script or through a
    # variable in the global.R script
    "DfE Shiny Template - All LA maintained schools, England"
  )
})
